...
from ncpi_fhir_utility.utils import requests_retry_session, check_service_status
...
class FhirApiClient(object):
    ...
    def post_or_put(self, endpoint, resource_dict, method="post"):
        ...
        success, result = self.send_request(method, endpoint, **request_kwargs)
    ...
    def delete_all(self, endpoint, **request_kwargs):
        ...
        success, result = self.send_request("get", endpoint, **request_kwargs)
    ...
    def check_service_status(self, exit_on_down=False, log_msg=None):
        ...
        down = check_service_status(
            self.status_endpoint or self.base_url,
            auth=self.auth,
